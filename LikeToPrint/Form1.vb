...
Public Class Form1
    ...
    Private Sub BtnSendFile_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSendFile.Click
        ...
        If ofd.ShowDialog(Me) Then
            ...
            End If
        End If
    End Sub ' BtnSendFile_Click()

    ' Click event handler for a button - designed to show how to use the
    ' SendBytesToPrinter function to send a string to the printer.
    Private Sub BtnSendString_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSendString.Click
        Dim s As String
        Dim pd As New PrintDialog()
